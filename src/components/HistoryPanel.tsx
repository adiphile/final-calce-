...
const HistoryPanel = ({ history, open, onClose, onSelect, onClear }: HistoryPanelProps) => {
  return (
    <>
      ...
      <div
        className={`fixed bottom-0 left-0 right-0 z-50 glass-surface rounded-t-3xl transition-transform duration-300 ease-out max-h-[70vh] flex flex-col ${
            ...
            <div className="space-y-1">
              {history.map((entry, i) => (
                <button
                  ...
                  className="w-full text-right py-3 px-4 rounded-xl hover:bg-muted/40 transition-colors"
                >
